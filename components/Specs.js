  ...
  return (
    <div className='bg-gray-100 shadow rounded p-2 text-left dark:bg-gray-800 dark:text-white'>
      <section className='bg-brand p-4 rounded md:w-full dark:bg-gray-800 dark:text-white'>
        <h2>Specs</h2>
        <p>Trons are stored as ERC-721 tokens on the Rinkeby testchain. and hosted on IPFS. Minting a Tron costs {ethers.utils.formatEther(cost)} ETH.</p>
        <h2>Fair Distribution</h2>
        <p>No bonding curves, no secret presale, just unbiased fairness. Buying a Tron costs {ethers.utils.formatEther(cost)} ETH. There are no price tiers – same chances for everyone!</p>
